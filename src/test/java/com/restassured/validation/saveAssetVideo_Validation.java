...
public class saveAssetVideo_Validation extends CommonPage
{
	 ...
	 * */
	  public saveAssetVideo_Validation saveAssetVideoStringVerification()
	  {
		  
		  JSONObject inputJSONObject = new JSONObject(saveAssetVideo.saveAssetVideo_valid_Inputs());
		  hash_Set = InsertValue("status","message",
				  "file_uuid","file_name","file_type","createdDate",
	  ...
	  /*
		 ...
		 * In this Function only pass the Key name in the 'hash_Set' and API function name in JSONObject argument.
		 * */
	public saveAssetVideo_Validation saveAssetVideoIntegerVerification()
	  {
	  ...
	  /*public saveAssetVideo_Validation saveAssetVideoArrayVerification()
	  {
		  JSONObject inputJSONObject = new JSONObject(saveAssetVideo.addform_valid_Inputs());
	  ...
	  */
	  public saveAssetVideo_Validation saveAssetVideoJsonVerification()
	  {
		  JSONObject inputJSONObject = new JSONObject(saveAssetVideo.saveAssetVideo_valid_Inputs());
	  ...
	  * This method validate the  Key is being passed is present in the response
		 ...
		 *
		 */
	  public saveAssetVideo_Validation saveAssetVideoyKeyPresent()
	  {
		 String APIResponse = saveAssetVideo.saveAssetVideo_valid_Inputs();
		  hash_Set = InsertValue("status","message",
	  ...
	  public saveAssetVideo_Validation saveAssetVideoStatuscode()
	  {
		  JSONObject inputJSONObject = new JSONObject(saveAssetVideo.saveAssetVideo_valid_Inputs());
	  ...
	  public saveAssetVideo_Validation ResponseTimeVerification()
	  {
		 long time = saveAssetVideo.saveAssetVideoResponseTime();
	  ...
	  public saveAssetVideo_Validation saveAssetVideoInvalidStringVerification()
	  {
		  
		  JSONObject inputJSONObject = new JSONObject(saveAssetVideo.saveAssetVideo_invalid_Inputs());
	  ...
	  public saveAssetVideo_Validation saveAssetVideoInvalidIntegerVerification()
	  {
	  ...
	  public saveAssetVideo_Validation saveAssetVideoInvalidKeyPresent()
	  {
		 String APIResponse = saveAssetVideo.saveAssetVideo_invalid_Inputs();
	  ...
	  public saveAssetVideo_Validation saveAssetVideoInvalidArrayVerification()
	  {
		  JSONObject inputJSONObject = new JSONObject(saveAssetVideo.saveAssetVideo_invalid_Inputs());
	  ...
	  public saveAssetVideo_Validation saveAssetVideoInvalidStatuscode()
	  {
		  JSONObject inputJSONObject = new JSONObject(saveAssetVideo.saveAssetVideo_invalid_Inputs());
		  hash_Set = InsertValue("code","status","message");
