...
public class getAssetAudio extends CommonPage
{
	...
	public String token = commonapis.loginAPI(ContentProperty.getEmail(),ContentProperty.getPassword(),ContentProperty.getProductkey(),ContentProperty.getProducttoken());
	  ...
	  public String getAssetAudio_valid_Inputs() 
	  { 
		  baseURI = ContentProperty.getURL();
	  
	  //request data (Json data) 
		  jsonparser("{\r\n" + 
		  		"   \"query\": \"{getAssets(app_token:\\\":app_token\\\",product_key:\\\":product_key\\\",asset_uuid:\\\"\\\",store_key:\\\"\\\",file_type:\\\"audio\\\")"
	  ...
	  public long getAssetAudioResponseTime()
	  {
	  ...
	  public String getAssetAudio_invalid_Inputs() 
	  { 
		  baseURI = ContentProperty.getURL();
