...
apiautomationframework com.restassured.productTest 22-02-2021
 */
...
public class mediaAddPage extends CommonPage
{
	...
	public String API = "ads/media/add";
	...
	public void PassingBodydata()
	{
		jsonparser("{\n" + 
		  		...
		  		"        }\n" + 
		  		"    ],\n" + 
		  		"    \"redirect_link\": \"http://www.muvi.com\",\n" + 
		  		"    \"edit\": \"\"\n" + 
		  		"}");
	}
	  public String mediaAdd_valid_Inputs() 
	  { 
