...
public class editContent extends CommonPage
{
	...
	public String token = commonapis.loginAPI(ContentProperty.getEmail(),ContentProperty.getPassword(),ContentProperty.getProductkey(),ContentProperty.getProducttoken());
	  ...
	  public String editContent_valid_Inputs() 
	  { 
	  ...
	  //request data (Json data) 
		  jsonparser("{     \r\n" + 
		  		...
		  		"\"content_name\":\"AutomationContentEdit\",\r\n" + 
	  ...
	  public long editContentResponseTime()
	  {
	  ...
	  public String editContent_invalid_Inputs() 
	  { 
		  baseURI = ContentProperty.getURL();
	  ...
	  //request data (Json data) 
		  jsonparser("{  \r\n" + 
			  		...
			  		"\"content_banner_uuid\":\"\",\r\n" + 
			  		" \"content_uuid\":\"\",\r\n" +
			  		"\"content_app_poster_uuid\":\"\",\r\n"+
			  		"\"cast_type\":\"1DBAEF123456EC3\",\r\n" + 
			  		"\"cast_type_input\":\"\",\r\n" + 
			  		"\"cast_items\":[\r\n" + 
			  		"        {\r\n" + 
			  		"                \"cast_trans_cast_uuid\":\"83ffa1f712b442a5996a77c204c0ad7c\",\r\n" + 
	  ...
	  public String gettingContentid()
	  {
			...
			System.out.println("Content token "+ResponseData.get("data.content_uuid"));
